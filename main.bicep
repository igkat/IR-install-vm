...
param _artifactsLocation string = 'https://raw.githubusercontent.com/igkat/azure-quickstart-templates/master/quickstarts/microsoft.compute/vms-with-selfhost-integration-runtime/azuredeploy.json'
